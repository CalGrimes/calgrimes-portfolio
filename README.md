...
View the live demo at [https://calgrimes.co.uk/](https://calgrimes.co.uk)
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/calgrimes/calgrimes-portfolio.git my-portfolio
   cd my-portfolio
   ```
...
- Built by [Cal Grimes](https://github.com/calgrimes)
...
[![Star History Chart](https://api.star-history.com/svg?repos=calgrimes/calgrimes-portfolio&type=Date)](https://star-history.com/#calgrimes/calgrimes-portfolio&Date)

---

**Built with ❤️ by [Cal Grimes](https://github.com/calgrimes)**
